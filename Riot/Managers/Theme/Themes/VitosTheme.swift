...
/// Color constants for the Vitos theme
@objcMembers
class VitosTheme: NSObject, Theme {
    ...
    var headerBackgroundColor: UIColor = UIColor(rgb: 0xC8D200)
    ...
    var tintColor: UIColor = UIColor(rgb: 0x0093D0)
    var tintBackgroundColor: UIColor = UIColor(rgb: 0x0093D0)
