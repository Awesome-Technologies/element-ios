...
internal enum VectorL10n {
  ...
  /// By submitting your request for registration data will be transmitted to us.\n\nWe collect your first and surname, your email adress, as well as the used app and iOS version.
  ...
  /// Direct Chat
  internal static var roomDetailsTitleDirectChat: String { 
    return VectorL10n.tr("Vector", "room_details_title_direct_chat") 
  }
  /// Topic
  ...
  /// since
  internal static var roomParticipantsSince: String { 
    return VectorL10n.tr("Vector", "room_participants_since") 
  }
  /// Participants
  ...
  /// Caritas
  internal static var settingsUiThemeCaritas: String { 
    return VectorL10n.tr("Vector", "settings_ui_theme_caritas") 
  }
  /// Dark
