...
internal enum AppDefaults {
  internal enum AMPChatDefaults {
    ...
    internal static let editableProfileInfo: Bool = _document["editableProfileInfo"]
    ...
    internal static let privacyPolicyFilePath: String = _document["privacyPolicyFilePath"]
    ...
    internal static let requireLocalAuthentication: Bool = _document["requireLocalAuthentication"]
    ...
    internal static let showRageShakeOption: Bool = _document["showRageShakeOption"]
    ...
    internal static let supportGroupCalls: Bool = _document["supportGroupCalls"]
    internal static let supportedThemes: [String] = _document["supportedThemes"]
    internal static let termsAndConditionsFilePath: String = _document["termsAndConditionsFilePath"]
