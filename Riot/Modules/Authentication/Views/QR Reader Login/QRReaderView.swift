...
class QRReaderView: MXKAuthInputsView, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    override func awakeFromNib() {
        self.qrCodeInfoLabel.text = AMPcareL10n.authQrTitle
        self.cameraPermissionLabel.text = AMPcareL10n.authQrNoPermission
        self.cameraPermissionButton.setTitle(AMPcareL10n.authQrAuthorize, for: .normal)
        self.cameraPermissionButton.setTitle(AMPcareL10n.authQrAuthorize, for: .highlighted)
