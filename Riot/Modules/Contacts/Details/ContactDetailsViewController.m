...
- (void)userInterfaceThemeDidChange
{
    ...
    self.headerView.backgroundColor = kCaritasSecondaryBgColor;
    self.contactNameLabel.textColor = kCaritasPrimaryTextColor;
    self.contactStatusLabel.textColor = kCaritasColorRed;
