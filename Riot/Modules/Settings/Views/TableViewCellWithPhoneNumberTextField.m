...
- (void)customizeTableViewCellRendering
{
    ...
    self.mxkLabel.textColor = kCaritasPrimaryTextColor;
    self.mxkTextField.textColor = kCaritasPrimaryTextColor;
    
    _isoCountryCodeLabel.textColor = kCaritasPrimaryTextColor;
}
